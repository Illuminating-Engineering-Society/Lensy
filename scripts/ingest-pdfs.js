...
import { deriveStandardId, inferFullDesignation } from '../src/lib/standard-id.js';
import {
...
// deriveStandardId / inferFullDesignation moved to src/lib/standard-id.js so
// the staff-dashboard ingest (src/workers/staff-ingest.ts) derives the SAME id
// from the same filename this script would.
